...
class models_genesis_config:
    ...
    model = "nnUnet3DFullres"
    suffix = "genesis_oct"
    exp_name = model + "-" + suffix
    
    # data
    data = "/home/gridsan/nchutisilp/datasets/Unlabeled_OCT_cubes/"
    ...
    # logs
    model_path = "/home/gridsan/nchutisilp/datasets/ModelGenesisOutputs/ModelGenesisNNUNetPretrainingV2_noNorm_correct_orientation"
    ...
    # wandb
    wandb_project_name = "Genesis_nnUNet_Pretraing_Correct_Orientation"
    wandb_run_name = None
    wandb_run_id = None # for a new run, it will be auto generated, otherwise, specify the run id to resume. Don't forget to set weights to resume the training.
