...
class models_genesis_config:
    ...
    # model pre-training
    verbose = 1
    weights = "/storage_bizon/naravich/ModelGenesisNNUNetPretrainingV2_noNorm/Genesis_OCT_Latest.pt"
    batch_size = 96
    optimizer = "sgd"
    workers = 2
    ...
    # logs
    model_path = "/storage_bizon/naravich/ModelGenesisNNUNetPretrainingV2_noNorm/"
    ...
    # wandb
    wandb_project_name = "Genesis_nnUNet_Pretraing"
    wandb_run_name = None
    wandb_run_id = "oj1g0v5j" # for a new run, it will be auto generated, otherwise, specify the run id to resume. Don't forget to set weights to resume the training.
